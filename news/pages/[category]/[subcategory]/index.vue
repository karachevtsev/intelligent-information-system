                ...
                <div class="box">
                    <div class="box-header">
                        <h1 class="text-center">
                            Усі новини рубрики <span class="title-marked">«{{ subcategory.title }}»</span>
                        </h1>
                    </div>
                    <div class="box-content pb-0">
                        <div class="articles-list-title">Новин:
                            <number :value="total"/>
                        </div>
...
const { articles, more, toPage, total, page, pages, category, subcategory } = await getContentListContext({
